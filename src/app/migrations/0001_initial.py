...
import app.internal.models.account_card
import app.internal.models.admin_user
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Account',
            fields=[
                ('number', models.PositiveBigIntegerField(primary_key=True, serialize=False, unique=True, validators=[app.internal.models.account_card.validate_account], verbose_name='Account number')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(blank=True, default=None, max_length=12, null=True, validators=[app.internal.models.admin_user.validate_phone], verbose_name='phone number')),
        ...
        migrations.CreateModel(
            name='Card',
            fields=[
                ('number', models.PositiveBigIntegerField(primary_key=True, serialize=False, unique=True, validators=[app.internal.models.account_card.validate_card], verbose_name='Card number')),
